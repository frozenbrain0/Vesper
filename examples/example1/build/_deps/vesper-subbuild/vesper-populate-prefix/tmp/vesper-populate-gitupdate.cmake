...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "prerelease_0.942"
  WORKING_DIRECTORY "/home/xenon/PROJECTS/cpp/vesper/examples/example1/build/_deps/vesper-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "prerelease_0.942")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("prerelease_0.942" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: prerelease_0.942")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/prerelease_0.942")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"prerelease_0.942\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/xenon/PROJECTS/cpp/vesper/examples/example1/build/_deps/vesper-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/xenon/PROJECTS/cpp/vesper/examples/example1/build/_deps/vesper-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
